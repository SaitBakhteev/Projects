...
'On Error GoTo err
 Open App.Path & "\Resources\lines.txt" For Input As #1
 Input #1, slovo
...
.Rows = .Rows + 1
last_row = .Rows - 1: .TextMatrix(last_row, 0) = last_row: .TextMatrix(last_row, 1) = line_: .TextMatrix(last_row, 2) = WL_
End With
